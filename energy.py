...
def recommended_action(forecast:str)->str:
...
def run_demo_without_api():
    '''Demo version that runs wihtout requiring OpenAI API key'''
    ...
    recommendation = recommended_action(forecast_result)
...
if __name__ == "__main__":
    ...
    print("-"*50)
    #Try with API version first, fallback to demo if no API key
    run_with_api()